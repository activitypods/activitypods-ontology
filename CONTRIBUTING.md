# Contributing to activitypods-ontology

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
activitypods-ontology. These guidelines are not strict rules.
...
The activitypods-ontology team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the activitypods-ontology technical leads
...
[issues]: https://github.com/activitypods/activitypods-ontology/issues/
[pulls]: https://github.com/activitypods/activitypods-ontology/pulls/
